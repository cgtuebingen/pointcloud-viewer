...
int main(int argc, char** argv)
{
  ...
  // TODO I have th efull contoll over the stream! I can copy blocks of the ply file to the memory and read them with file.read? Can I? THis way, I can have a progress bar!! :D
